...
def build():
    ...
    add(code('# 1. flip the lamp (toggle = whatever it is now, becomes the opposite):\n'
             ...
             'sleep 12; curl -s -G "https://voiceorchestrator.homeadapt.us/api/v1/voice-auth/items/search" \\\n'
             '  -H "Authorization: Bearer sk_ios_48b546d143dae04ec9d2c4396ae9155648e80a5ffbaf3377" \\\n'
             '  --data-urlencode "user_ref=scott_mobile" --data-urlencode "home_id=scott_home" \\\n'
             '  --data-urlencode "q=man_land_lamp"\n'
